...
\subsection{Straßen-Szenario}
\label{subsec:straßen-szenario}
...
Dabei ist \textit{ackPBSM} unabhängig vom Straßen-Szenario aus \ref{subsec:straßen-szenario} und funktioniert sowohl für \textit{eindimensionale} als auch für \textit{zweidimensionale} Szenarios.
