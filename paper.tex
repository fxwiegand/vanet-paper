...
Um beim Übertragung eine möglichst geringe zeitliche Verzögerung zu haben, werden ständig die einzelnen Übertragungszeiten mit Hilfe von Echtzeit-Daten zwischen den einzelnen Knoten berechnet um so die Übertragung mit geringstmöglicher Verzögerung durchführen zu können.
Ein wichtiger und vermutlich entscheidender Faktor bei der realen Nutzbarkeit des Protokolls spielen die stationären RSUs.
